...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnumIn("configKeys", ConfigManager::CLASSIC_ATTACKSPEED)
	...
	registerMethod("Player", "setLossSkill", LuaScriptInterface::luaPlayerSetLossSkill);
...
int LuaScriptInterface::luaPlayerSetLossSkill(lua_State * L)
{
	// player:setLossSkill(doDrop)
	Player* creature = getUserdata<Player>(L, 1);
	if (creature) {
