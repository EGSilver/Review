...
enum ConditionParam_t {
	...
	CONDITION_PARAM_SPECIALSKILL_HITPOINTSLEECHCHANCE = 49,
	CONDITION_PARAM_SPECIALSKILL_HITPOINTSLEECHAMOUNT = 50,
	CONDITION_PARAM_SPECIALSKILL_MANAPOINTSLEECHCHANCE = 51,
	CONDITION_PARAM_SPECIALSKILL_MANAPOINTSLEECHAMOUNT = 52,
};
